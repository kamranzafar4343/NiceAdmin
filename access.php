...
$showOrders = "Select * FROM orders where flag = 'Access' ORDER BY order_creation_date DESC";
...
<body> <!-- ======= Header ======= -->
    ...
    <button id="" type="button" onclick="window.location.href = 'createAccessWO.php';" class="btn btn-primary mb-1 add">+</button>
    <!-- Main content -->
    <main id="main" class="main">
        <div class="col-12">
            <div class="cardBranch recent-sales overflow-auto">
                <div class="card-body">
                    <h5 class="card-title">List of Access Work Orders</h5>
                    <?php
                    ...
                    if ($resultShowOrders->num_rows > 0) {
                     ...
                     <thead>
                        ...
                        // Display the "Action" column only if the user is an admin
