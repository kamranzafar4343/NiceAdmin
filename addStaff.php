...
// Start: code to add staff to a branch ; see testing/func1.php for more details
...
//apply check if a user already exit against that branch id??

    // Insert the record into the database
    $sql = "INSERT INTO `employee` (`branch_id_fk`, `name`, `email`, `phone`, `role`, `authority`) 
            VALUES ('$branch_id', '$employee', '$email', '$phone', '$role', '$auth')";
