...
if (isset($_POST['submit'])) {
    ...
    //check duplicate barcode entry in access table
    $check_duplicate_barcode = "SELECT barcode FROM orders WHERE barcode = '$barcodes' AND flag = 'Access'";
    ...
    if ($result_duplicate_barcode && $result_duplicate_barcode->num_rows > 0) {
     ...
     VALUES ( '$creator', 'Access', '$comp', '$branch', '$dept', 'Pending','$priority', '$date', '$foc', '$foc_phone', '$pickup_address', '$object_codes', '$barcodes', '$alt_codes', '$requestor_names', '$designation', '$request_dates', '$descriptions')";
    }
