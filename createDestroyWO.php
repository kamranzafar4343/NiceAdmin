...
if (isset($_POST['submit'])) {
    ...
    if ($result_duplicate_barcode && $result_duplicate_barcode->num_rows > 0) {
     ...
     VALUES ( '$creator', 'Destroy', '$comp', '$branch', '$dept', 'Pending', '$priority', '$date', '$foc', '$foc_phone', '$pickup_address', '$object_codes', '$barcodes', '$alt_codes', '$requestor_names', '$designation', '$request_dates', '$descriptions')";
    }
