...
if ($result->num_rows > 0) {
  ...
  $description = $dept_data['acc_desc'];
  $email = $dept_data['email'];
  $registration = $dept_data['registration'];
  $expiry = $dept_data['expiry'];
  $contact_person = $dept_data['foc'];
  $phone = $dept_data['foc_phone'];
  $address = $dept_data['add_1'];
  $e_role = $dept_data['role'];
  $e_auth = $dept_data['auth'];
}
        ...
        <div class="col-md-4">
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <h4 class="card-title mt-0"><?php echo $dept_name; ?></h4>
