...
<head>
    ...
    <title>Destroy Workorders</title>
        ...
        <div class="col-15">
            ...
            <div class="cardBranch recent-sales overflow-auto">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <h5 class="card-title">Destroy Work Orders</h5>
                        </div>
                        <div class="col-6 text-end mt-2">
                            <button type="button" onclick="window.location.href = 'createDestroyWO.php'" class="btn btn-primary mb-3">Add</button>
                        </div>
                    </div>
                  ...
                  WHERE d.dept_name LIKE '%$value%'";
                            ...
                            $query = "SELECT * FROM orders WHERE flag = 'Destroy' AND $column LIKE '%$value%' ORDER BY order_creation_date DESC";
                        }
                    }
                    ...
                    if (isset($_GET['filter_date']) && !empty($_GET['start_date']) && !empty($_GET['end_date'])) {
                        ...
                        $query = "SELECT * FROM orders WHERE flag = 'Destroy' AND order_creation_date BETWEEN '$start_date' AND '$end_date'";
                    }

                    // Show All Button
                    if (isset($_GET['show_all'])) {
                        $query = "SELECT * FROM orders where flag = 'Destroy' LIMIT 100";
                    }
                ...
                <tr>
                    ...
                    <th>Required By</th>';
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            //handles date and also handles empty date
