...
$showOrders = "Select * FROM orders where flag = 'Destroy'";
...
<body> <!-- ======= Header ======= -->
  ...
  <!-- sidebar end -->
    ...
    <button id="" type="button" onclick="window.location.href = 'createDestroyWO.php';" class="btn btn-primary mb-1 add">+</button>
    <!-- Main content -->
    <main id="main" class="main">
        <div class="col-12">
            <div class="cardBranch recent-sales overflow-auto">
                <div class="card-body">
                    <h5 class="card-title">List of Destroy Work Orders</h5>
                    <?php
