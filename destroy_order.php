...
<body>
    ...
    <button id="" type="button" onclick="window.location.href = 'create_destroy_order.php';" class="btn btn-primary mb-3 add">Destroy Order</button>
    <!-- Main content -->
    <main id="main" class="main">
        <div class="col-12">
            <div class="cardBranch recent-sales overflow-auto">
                <div class="card-body">
                    <h5 class="card-title">List of Destroy Orders</h5>
                    <?php
