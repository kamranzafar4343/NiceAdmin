            ...
            <div class="col-md-6 col-lg-4 pb-3">
                <div class="card card-custom bg-white border-white border-0">
                    ...
                    <div class="card-body list-group mt-3">
                        ...
                        <h4 class="card-title-info"><b>Items Info</b></h4>
                        ...
                        <ul class="list-group list-group-horizontal d-flex justify-content-between">
                            ...
                            <li class="list-group-item text-end" style="text-align: right; width: 55%;"><?php echo $item_data['rack_location']; ?></li>
                        </ul>
                        <ul class="list-group list-group-horizontal-sm d-flex justify-content-between">
                            ...
                            <li class="list-group-item text-end" style="text-align: right; width: 55%;"><?php echo $item_data['rack_description']; ?></li>
                        </ul>
                        <ul class="list-group list-group-horizontal-md d-flex justify-content-between">
                            ...
                            <li class="list-group-item" style="text-align: right;width: 55%;"><?php echo $item_data['object_code']; ?></li>
                        </ul>
                        <ul class="list-group list-group-horizontal-lg d-flex justify-content-between">
                            ...
                            <li class="list-group-item" style="text-align: right; width: 55%;"><?php echo $item_data['capacity']; ?></li>
                        </ul>
                        <ul class="list-group list-group-horizontal-lg d-flex justify-content-between">
                            <li class="list-group-item" style="color:grey; width: 39%;">Createcd At</li>
                            <li class="list-group-item" style="text-align: right; width: 55%;"><?php echo $item_data['created_at']; ?></li>
                        </ul>

                
                        <h4 class="card-title-info"><b><?php echo $item_data['rack_location']; ?></b></h4>
