...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    // Sanitize the store ID
    $store_id = mysqli_real_escape_string($conn, $_GET['id']);

    // Fetch store details along with the related box details using a JOIN
    $sql = "SELECT store.*, box.barcode AS barcode_select
            FROM store 
            LEFT JOIN box ON store.barcode_select = store.id 
            WHERE store.id = '$store_id'";

    $result = $conn->query($sql);

    if ($result && $result->num_rows > 0) {
        // Fetch the store data along with the barcode
                ...
                <div class="card card-custom bg-white border-white border-0">
                    ...
                    <div class="card-body list-group mt-3">
                        ...
                        <ul class="list-group list-group-horizontal d-flex justify-content-between">
                            ...
                            <li class="list-group-item text-end" style="text-align: right; width: 55%;"><?php echo $store_data['rack_location']; ?></li>
                        </ul>
                        <ul class="list-group list-group-horizontal-sm d-flex justify-content-between">
                            ...
                            <li class="list-group-item text-end" style="text-align: right; width: 55%;"><?php echo $store_data['rack_description']; ?></li>
                        </ul>
                        <ul class="list-group list-group-horizontal-md d-flex justify-content-between">
                            ...
                            <li class="list-group-item" style="text-align: right;width: 55%;"><?php echo $store_data['object_code']; ?></li>
                        </ul>
                        <ul class="list-group list-group-horizontal-lg d-flex justify-content-between">
                            ...
                            <li class="list-group-item" style="text-align: right; width: 55%;"><?php echo $store_data['capacity']; ?></li>
                        </ul>
                        <ul class="list-group list-group-horizontal-lg d-flex justify-content-between">
                            <li class="list-group-item" style="color:grey; width: 39%;">Createcd At</li>
                            <li class="list-group-item" style="text-align: right; width: 55%;"><?php echo $store_data['created_at']; ?></li>
                        </ul>

                
                        <h4 class="card-title-info"><b><?php echo $store_data['rack_location']; ?></b></h4>
