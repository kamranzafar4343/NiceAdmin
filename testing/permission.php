...
<body> <!-- ======= Header ======= -->
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" data-bs-target="#tables-nav" data-bs-toggle="" href="permission.php">
                    <i class="bi bi-shield-check"></i><span>Permission</span><i class="bi bi-chevron ms-auto"></i>
                </a>
            </li>
