...
//  - - --  - - show previous staff in branch for editing - - -- -- 
...
// Check if editing (if emp_id is passed)
if ($emp_id) {
    // Fetch emp data
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($_POST['action'] == 'add'){
        // Add staff to branch
        $sql = "INSERT INTO `employee` (`branch_id_fk`, `name`, `email`, `phone`, `role`, `Authority`) 
            VALUES ('$branch_id_fk', '$employee', '$emp_email', '$phone', '$role', '$auth')";

    if (mysqli_query($conn, $sql)) {
        header("Location: branchInfo.php?id=" . $branch_id_fk);
    ...
    if($_POST['action'] == 'edit' && isset($_POST['emp_id'])){
        // Update staff in branch
        $sql = "UPDATE `employee` SET `name`='$name', `role`='$role', `authority`='$authority' WHERE `emp_id`='$emp_id'";
...
<body> <!-- ======= Header ======= -->
    ...
    <div class="headerimg text-center">
        ...
        <h2><?php echo $action == 'add' ? 'Add ' : 'Update '; ?> Staff</h2>
    </div>
            ...
            <div class="card-body">
                ...
                <form class="row g-3 needs-validation" action="" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" id="" name="email" value="<?php echo $emp_email; ?>" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="role" id="" class="form-select" required>
                            ...
                            <option value="Branch Manager" <?php if ($role == "Branch Manager") echo "selected"; ?>>Branch Manager</option>
                            <option value="Department Manager" <?php if ($role == "Department Manager") echo "selected"; ?>>Department Manager</option>
                            <option value="Junior Employee"  <?php if ($role == "Junior Employee") echo "selected"; ?>>Junior Employee</option>
                            <option value="Head of Operations"  <?php if ($role == "Head of Operations") echo "selected"; ?>>Head of Operations</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="authority" id="" class="form-select">
                            ...
                            <option value="can get information about branch boxes" <?php if ($authority == "can get information about branch boxes") echo "selected"; ?>>can get information about branch boxes</option>
                            <option value="only retrieve department boxes" <?php if ($authority == "only retrieve department boxes") echo "selected"; ?>>only retrieve department boxes</option>
                            <option value="all departments of their branch" <?php if ($authority == "all departments of their branch") echo "selected"; ?>>all departments of their branch</option>
                            <option value="all departments and all branches of company" <?php if ($authority == "all departments and all branches of company") echo "selected"; ?>>all departments and all branches of company</option>
                        </select>
                    </div>

                    <div class="text-center mt-4 mb-2">
                        <button type="submit" class="btn btn-outline-primary mr-2" name="submit" value="<?php echo $action == 'add' ? 'Add User' : 'Update User'; ?>">Submit</button>
